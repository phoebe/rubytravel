...
class OHwines < Scraper
  ...
  def parsePage(doc, info ) 
    ...
    h = info.dup
    #doc.search('.//hr/preceding-sibling::node()|.//hr/following-sibling::node()|.//hr/preceding-sibling::text()|.//hr/following-sibling::text()|.//br/preceding-sibling::node()|.//br/following-sibling::node()|.//br/preceding-sibling::text()|.//br/following-sibling::text()').each { |lll|
    ...
    #puts "#{ h.inspect } "
    enterIntoDB(h,{"type"=>"wineries"}) unless h['postal_code'].blank?
  }
  #
=begin
